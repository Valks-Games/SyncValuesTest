...
public abstract class ENetClient
{
    ...
    /// </summary>
    public static readonly Dictionary<ServerPacketOpcode, APacketServer> HandlePacket = ENetUtils.LoadInstances<ServerPacketOpcode, APacketServer>("SPacket");
