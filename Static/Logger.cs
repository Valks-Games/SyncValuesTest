...
public class Logger : ILogger
{
	...
	/// Log a message
	/// </summary>
	public void Log(object message, ConsoleColor color = ConsoleColor.Gray) =>
		Messages.Enqueue(new LogInfo(LoggerOpcode.Message, new LogMessage($"{message}"), color));

	/// <summary>
	/// Log a warning
	/// </summary>
	public void LogWarning(object message, ConsoleColor color = ConsoleColor.Yellow) =>
		Log($"[Warning] {message}", color);

	/// <summary>
	/// Log a todo
	/// </summary>
	public void LogTodo(object message, ConsoleColor color = ConsoleColor.White) =>
	...
	/// </summary>
	private void LogDetailed(LoggerOpcode opcode, string message, ConsoleColor color, bool trace, string filePath, int lineNumber) =>
